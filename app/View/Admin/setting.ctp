                    ...
                    <div class="tab-pane fade in active" id="tab1default">
                        <form class="form-horizontal" role="form" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="email" name="email" class="form-control" id="email_1" maxlength="30" placeholder="Email" value="<?php echo @$params['email_1']; ?>">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-sm-2" for="email_2">Email:</label>
                                <div class="col-sm-10">
                                  <input type="email" name="email" class="form-control" id="email_2" maxlength="30" placeholder="Email" value="<?php echo @$params['email_2']; ?>">
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-sm-2" for="address_1_vi">Địa chỉ 1:</label>
                                <div class="col-sm-10">
                              ...
                              <div class="form-group">
                                <label class="control-label col-sm-2" for="tel_1">Điện thoại 1:</label>
                                <div class="col-sm-10"> 
                              ...
                              <div class="form-group">
                                <label class="control-label col-sm-2" for="fax_1">Fax 1:</label>
                                <div class="col-sm-10"> 
