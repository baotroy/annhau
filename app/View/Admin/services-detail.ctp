                ...
                <div class="tab-content">
                    <div class="tab-pane fade <?php if(!isset($bar) || @$bar==1) echo 'in active'; ?>" id="tab1default">
                              ...
                              <div class="form-group">
                                <label class="control-label col-sm-2" for="name_vi">Tên dịch vụ</label>
                                <div class="col-sm-10">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  ...
                                  <?php if(@$item['image']):?>
                                        <img src="<?php echo $this->Text->image($item['image'], DIR_UPLOAD) ?>" alt="<?php echo $item['name_vi']; ?>" width="100"/>
                                  <?php endif; ?>
                                </div>
                    ...
                    <div class="tab-pane fade <?php if(@$bar==2) echo 'in active'; ?>" id="tab2default">
                           <div class="form-group">
                              <label class="control-label col-sm-2" for="name_en">Tên dịch vụ</label>
                              <div class="col-sm-10">
                                <input type="text" name="name_en" class="form-control" id="name_en" maxlength="255" placeholder="" value="<?php echo @$item['name_en']; ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="description_en">Mô tả<span class="required">*</span></label>
                              <div class="col-sm-10">
