		...
		<div class="container">
			...
			<div class="about-info">
				...
				<div class="col-md-5 about-info-left">
					<img src="<?php echo $this->base ?>/images/about.jpg" alt=""/>
				</div>
				<div class="col-md-7 about-info-right">
					...
					There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour,  to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, 
					or randomised words which don't look even slightly believable.Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour,  to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, 
					...
					<div class="col-sm-6 col-md-3 about-team-grids">
						<div class="thumbnail">
							<a href="images/img8.jpg" class=" mask b-link-stripe b-animate-go   swipebox"  title="Image Title">
								<img src="<?php echo $this->base ?>/images/img8.jpg" alt="" class="img-responsive zoom-img"/>
							</a>
							<div class="caption">
					...
					<div class="col-sm-6 col-md-3 about-team-grids">
						<div class="thumbnail">
							<a href="images/img9.jpg" class=" mask b-link-stripe b-animate-go   swipebox"  title="Image Title">
								<img src="<?php echo $this->base ?>/images/img9.jpg" alt="" class="img-responsive zoom-img"/>
							</a>
							<div class="caption">
					...
					<div class="col-sm-6 col-md-3 about-team-grids">
						<div class="thumbnail">
							<a href="images/img10.jpg" class=" mask b-link-stripe b-animate-go   swipebox"  title="Image Title">
								<img src="<?php echo $this->base ?>/images/img10.jpg" alt="" class="img-responsive zoom-img"/>
							</a>
							<div class="caption">
					...
					<div class="col-sm-6 col-md-3 about-team-grids">
						<div class="thumbnail">
							<a href="images/img11.jpg" class=" mask b-link-stripe b-animate-go   swipebox"  title="Image Title">
								<img src="<?php echo $this->base ?>/images/img11.jpg" alt="" class="img-responsive zoom-img"/>
							</a>
							<div class="caption">
